...
for (let i = 0; i < charactersNames.length; i++) {
  for (let n = 0; n < femaleCharacters.length; n++) {
    if (femaleCharacters[n].name === charactersNames[i]) {
...
*/
function random() {
  const randomIndex = Math.round(Math.random() * starWarsCharacters.length)
  console.log(Math.random())
  console.log(Math.random() * starWarsCharacters.length)
  console.log(Math.floor(Math.random() * starWarsCharacters.length))
  console.log(starWarsCharacters[randomIndex])
}
